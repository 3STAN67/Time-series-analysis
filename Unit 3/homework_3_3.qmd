...
hw_add <- HoltWinters(df_ts, seasonal = 'additive')
...
::: {.callout-note title="Answer" icon="false"}
I did not estimate the parameters but allowed R to automatically estimate the optiam aphla, beta, and gamma. It does this by minimizing the sum of squared errors. 
...
hw_forecast <- forecast(hw_add, h = 24)
