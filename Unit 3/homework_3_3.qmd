...
::: {.callout-note title="Revision" incon="false"}
I changed the code to more align with the answer key and updated my responses to the questions. I also finished the last question. 
:::
...
Data Collection: This data is derived from death certificates filed in the 50 U.S. states and District of Columbia. States code the death certificates and provide them to the National Center for Health Statistics (NCHS) through state registration or via direct copies. The cause of death is defined under the World Health Organization (WHO) definition: "the disease or injury which initiated the train of events leading directly to death, or the circumstances of the acciedent or violence which preceded the fatal injury."

Unit of Analysis: The unit of analysis is the number of deaths from a cause.

Meaning of Observation: Each observation is an aggregation of the number of deaths from a cause at a given period of time.
:::
...
::: {.callout-note title="Answer" icon="false"}
Alpha - 0.15
A small alpha was used to smooth out short-term fluctuations and give weight to larger trends.
Beta - 0.0005
A small beta was used on the basis that mortality rate is expected to be consistent and change gradually over time. 
Gamma - 0.01
The small gamma was used as seasonal patterns are consistent and evolve slowly.
...
The forecast estimated higher peaks than the actual result. A gray rhino is a highly probable, high impact event that is often ignored unitl it occurs like the pandemic. Since the model relies on continuity and historical patterns and would not be able to predict a sudden or abrupt event. Forecasting is probabilistic and not absolute and needs to be kept in the context of the data.
:::
