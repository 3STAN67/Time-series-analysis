...
ggplot(mortality, aes(x = year)) +
  geom_line(aes(y = `mort_rate_per_100,000`, color = "Observed"), linewidth = 1.2) +
  geom_line(aes(y = ETS_fit, color = "Model 1"), linewidth = 1.2) +
...
::: {.callout-note title="Answer" icon="false"}
There may not be a exactly correct weight or parameter but the context of the data has to be considered. From this we can attempt to best choose parameters that reflect the real world.
:::
