...
This data is monthly averages of noon buying rates in New York City for cable transfers payable in foreign currencies. The monthly values are averages of the daily data available.
...
polyroot(c(0.004802754, 1.256, -0.326, 0.129, -0.064)) %>% abs() %>% round(3)
...
polyroot(c(0.259, -0.067, 0.061)) %>% abs() %>% round(3)
