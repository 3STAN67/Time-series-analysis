...
The correlogram shows a high degree of correlation at different lags. This is a second order property of random walks but does not confirm if it is or not. 
:::
...
Based on the correlogram, it appears that the first order difference could be white noise. There are a few significant points outside of the confidence interval but we could expect 5% of the data to be outside of those lines and so these do not appear to be practicially significant. 
:::
...
The 95% confidence interval contains 0, and so it can not be concluded that there is evidence of a positive drift in the price of Sofi. 
:::
