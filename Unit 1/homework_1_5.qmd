...
This is a historical time-series data set that records the monthly volume of boats or other means of transportation cleared in foreign trade for the U.S. in units of thousands of net tons. Cleared in this context would be vessels that have departed. This is data was collected by the U.S. Bureau of Foreign and Domestic Commerce and later digitized by the National Bureau of Economic Research.
:::
...
The additive model greatly overestimates the random compnent shown by the much large scale of the y-axis compared to the multiplicative model. This makes sense as the additive model does not accuretly scale the seasonal component so it would be compensated by the trend or random component.
:::
